...
namespace Application.Common.Localization.Caching
{
    internal sealed class CacheHelper
    {
        ...
        public bool TryGetValue(string cacheKey, out ConcurrentDictionary<string, LocalizedFormat> localization)
        {
            ...
            if (_distributedCache != null)
            {
                ...
                localization = JsonConvert.DeserializeObject<ConcurrentDictionary<string, LocalizedFormat>>(json);
                return true;
            }
        ...
        public void Set(string cacheKey, ConcurrentDictionary<string, LocalizedFormat> localization, TimeSpan cacheDuration)
        {
