using Application.Common.Localization.Caching;
using Application.Common.Localization.Configuration;
using Application.Common.Localization.Format;
using Application.Common.Localization.Localizer.Modes;
...
namespace Application.Common.Localization.Localizer
{
    internal class JsonStringLocalizerBase
    {
        ...
        private void ConstructLocalizationObject(string jsonPath, CultureInfo currentCulture)
        {
            ...
            {
                localization = new ConcurrentDictionary<string, LocalizedFormat>();
            }
