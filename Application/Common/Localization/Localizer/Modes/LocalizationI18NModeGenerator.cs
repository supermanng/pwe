...
namespace Application.Common.Localization.Localizer.Modes
{
    ...
    {
        private LocalizedFormat GetLocalizedValue(KeyValuePair<string, string> temp, bool isParent)
        {
        ...
        public ConcurrentDictionary<string, LocalizedFormat> ConstructLocalization(IEnumerable<string> myFiles,
        ...
        private void AddValueToLocalization(JsonLocalizationOptions options, string file, bool isParent)
        {
            ...
            {
                LocalizedFormat localizedValue = GetLocalizedValue(temp, isParent);
